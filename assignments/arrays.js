...
for (i = 0; i <= lastCar; i++){
  ...
  //console.log(i + ' ' + carModels[i]);    //<----Debug text
...
for (i = 0; i <= lastCar; i++){
  ...
  console.log((i+1) + ' ' + carModelsSorted[i]);    //i+1 is to make sure the output makes sense for end-user.
}
...
for (let i = 0; i <= lastCar; i++){
  ...
  console.log((i+1) + ' ' + carYears[i]);    //<----Debug text
...
for (let i = 0; i <= lastCar; i++){
  ...
  if( carYears[i] < 2000){  //if the current inspected car is older than 2000 add it to the new array
...
for (let i = 0; i <= lastCar; i++){
  ...
  if( inventory[i].car_make === 'BMW' || inventory[i].car_make === 'Audi' ){  //if the current inspected car is bmw or audi
